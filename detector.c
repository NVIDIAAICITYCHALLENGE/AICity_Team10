...
void train_detector(char *datacfg, char *cfgfile, char *weightfile, int *gpus, int ngpus, int clear)
{
    ...
    char *train_images = option_find_str(options, "train", "/workspace/darknet/aic480-darknet/train/train.txt");
...
void validate_detector_flip(char *datacfg, char *cfgfile, char *weightfile, char *outfile)
{
    int j;
    list *options = read_data_cfg(datacfg);
    char *valid_images = option_find_str(options, "valid", "/workspace/darknet/aic480-darknet/test/test.txt");
...
void validate_detector_recall(char *cfgfile, char *weightfile)
{
    ...
    list *plist = get_paths("/workspace/darknet/aic480-darknet/test/test.txt");
    char **paths = (char **)list_to_array(plist);
...
void run_detector(int argc, char **argv)
{
    ...
    if(0==strcmp(argv[2], "test")) test_detector(datacfg, cfg, weights, filename, thresh, hier_thresh, outfile, fullscreen);
        ...
        list *options = read_data_cfg(datacfg);
        int classes = option_find_int(options, "classes", 15);
        char *name_list = option_find_str(options, "names", "data/voc.names");
        char **names = get_labels(name_list);
